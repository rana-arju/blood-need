    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-b from-red-50 to-white dark:from-gray-900 dark:to-gray-800 p-4 transition-all duration-300">
      ...
      <div className="w-full max-w-5xl flex flex-col md:flex-row-reverse items-center gap-8">
        ...
        <div className="w-full md:w-1/2 hidden md:flex flex-col items-center justify-center p-6">
          ...
          <p className="text-center text-gray-600 dark:text-gray-300 max-w-md">{t("signUp.heroText")}</p>
        </div>
              ...
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                <div className="space-y-2">
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className="text-gray-700 dark:text-gray-300">{t("signUp.nameLabel")}</FormLabel>
                        <FormControl>
                ...
                <div className="space-y-2">
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className="text-gray-700 dark:text-gray-300">{t("signUp.emailLabel")}</FormLabel>
                        <FormControl>
                          <div className="relative">
                ...
                <div className="space-y-2">
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className="text-gray-700 dark:text-gray-300">{t("signUp.passwordLabel")}</FormLabel>
                        <FormControl>
                          <div className="relative">
